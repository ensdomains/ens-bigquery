...
CREATE OR REPLACE TABLE `web3-publicgoods.ens_temp2.raw_base_registrar_events` AS
SELECT 
    block_timestamp,
    block_number, 
    transaction_hash,
...
CREATE OR REPLACE TABLE `web3-publicgoods.ens_temp2.decoded_base_registrar_NameMigrated` AS
SELECT 
    block_timestamp,
    block_number,
    log_index,
...
FROM `web3-publicgoods.ens_temp2.raw_base_registrar_events`
...
CREATE OR REPLACE TABLE `web3-publicgoods.ens_temp2.decoded_base_registrar_NameRegistered` AS
SELECT 
    block_timestamp,
    block_number,
    log_index,
...
CREATE OR REPLACE TABLE `web3-publicgoods.ens_temp2.decoded_base_registrar_NameRenewed` AS
SELECT 
    block_timestamp,
    block_number,
    log_index,

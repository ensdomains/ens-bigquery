...
CREATE OR REPLACE TABLE `web3-publicgoods.ens._decoded_registry_NewOwner` AS
SELECT 
    block_timestamp,
    block_number,
    log_index,
...
CREATE OR REPLACE TABLE `web3-publicgoods.ens._decoded_registry_Transfer` AS
SELECT 
    block_timestamp,
    block_number,
    log_index,
...
CREATE OR REPLACE TABLE `web3-publicgoods.ens._decoded_registry_NewResolver` AS
SELECT 
    block_timestamp,
    block_number,
    log_index,

...
CREATE OR REPLACE TABLE `web3-publicgoods.ens._decoded_name_wrapper_NameWrapped` AS
SELECT
  transaction_hash,
  block_number,
  block_timestamp,
  ...
  data
FROM `web3-publicgoods.ens._raw_name_wrapper_events`
...
CREATE OR REPLACE TABLE `web3-publicgoods.ens._decoded_name_wrapper_NameUnwrapped` AS
SELECT
  transaction_hash,
  block_number,
  block_timestamp,
...
CREATE OR REPLACE TABLE `web3-publicgoods.ens._decoded_name_wrapper_FusesSet` AS
SELECT
  transaction_hash,
  block_number,
  block_timestamp,
...
CREATE OR REPLACE TABLE `web3-publicgoods.ens._decoded_name_wrapper_ExpiryExtended` AS
SELECT
  transaction_hash,
  block_number,
  block_timestamp,
...
CREATE OR REPLACE TABLE `web3-publicgoods.ens._decoded_name_wrapper_TransferSingle` AS
SELECT
  transaction_hash,
  block_number,
  block_timestamp,
...
CREATE OR REPLACE TABLE `web3-publicgoods.ens._decoded_name_wrapper_TransferBatch` AS
SELECT
  transaction_hash,
  block_number,
  block_timestamp,
...
CREATE OR REPLACE TABLE `web3-publicgoods.ens._decoded_name_wrapper_ApprovalForAll` AS
SELECT
  transaction_hash,
  block_number,
  block_timestamp,

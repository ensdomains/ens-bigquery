...
CREATE OR REPLACE TABLE `web3-publicgoods.ens._decoded_registrar_controller_NameRegistered_v3` AS
SELECT
  transaction_hash,
  block_number,
  block_timestamp,
...
CREATE OR REPLACE TABLE `web3-publicgoods.ens._decoded_registrar_controller_NameRegistered_v4` AS
SELECT
  transaction_hash,
  block_number,
  block_timestamp,

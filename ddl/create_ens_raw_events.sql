...
CREATE OR REPLACE TABLE `web3-publicgoods.ens.raw_registry_events` AS
SELECT 
    log_index,
    transaction_hash,
    transaction_index,
...
CREATE OR REPLACE TABLE `web3-publicgoods.ens.raw_resolver_events` AS
SELECT 
    log_index,
    transaction_hash,
    transaction_index,
...
CREATE OR REPLACE TABLE `web3-publicgoods.ens.raw_registrar_events` AS
SELECT 
    log_index,
    transaction_hash,
    transaction_index,
...
CREATE OR REPLACE TABLE `web3-publicgoods.ens.raw_controller_events` AS
SELECT 
    log_index,
    transaction_hash,
    transaction_index,
...
CREATE OR REPLACE TABLE `web3-publicgoods.ens.raw_name_wrapper_events` AS
SELECT 
    log_index,
    transaction_hash,
    transaction_index,

...
CREATE OR REPLACE TABLE `web3-publicgoods.ens_temp2.state_registry_owners` AS
...
CREATE OR REPLACE TABLE `web3-publicgoods.ens_temp2.state_registry_resolvers` AS
...
CREATE OR REPLACE TABLE `web3-publicgoods.ens_temp2.state_registry_labels` AS
